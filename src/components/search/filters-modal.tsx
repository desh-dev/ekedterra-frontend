              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white shadow-xl transition-all">
                ...
                <div className="px-6 pb-6 space-y-8 max-h-[70vh] overflow-y-auto">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {amenityOptions.slice(0, 3).map((amenity) => (
                        ...
                        >
                          ...
                          <span className="text-xs text-center font-medium">{amenity.label}</span>
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex space-x-2">
                      {[
                        ...
                        <button
                          key={type.value}
                          onClick={() => setFilters({ ...filters, propertyType: type.value as PropertyType })}
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-4">Trip price, includes all fees</p>
